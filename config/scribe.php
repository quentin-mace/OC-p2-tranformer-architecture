...
return [
    ...
    'description' => 'Renote REST API. All responses follow the {status, message, data} envelope.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Retrieve a token via `POST /api/register` or `POST /api/login`. Then send `Authorization: Bearer {token}` on every request.',
    ],
